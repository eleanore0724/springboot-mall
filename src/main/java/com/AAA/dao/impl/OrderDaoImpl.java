...
import com.AAA.rowmapper.OrderItemRowMapper;
import com.AAA.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao{
	...
	public List<Order> getOrders(OrderQueryParams orderQueryParams) {
		...
		List<Order> orderLisr= namedParameterJdbcTemplate.query(sql, map, new OrderRowMapper());
